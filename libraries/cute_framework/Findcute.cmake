...
elseif(MINGW)
	...
	find_library(
		CUTE_DLL_DEBUG libcute.dll
		HINTS ${CMAKE_CURRENT_LIST_DIR}
		PATH_SUFFIXES mingw/bin
	)
	find_library(
		CUTE_DLL_RELEASE libcute.dll
		HINTS ${CMAKE_CURRENT_LIST_DIR}
		PATH_SUFFIXES mingw/bin
	)
	...
	string(APPEND CF_DEBUG_PATH "v${CF_VS_VERSION}/")
	string(APPEND CF_RELEASE_PATH "v${CF_VS_VERSION}/")
